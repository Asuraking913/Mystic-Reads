...
function Weekly() {
    ...
    const storyList = novelList.map((items, i) => (<div key={i} className='h-[370px] flex flex-col gap-[.5em]'>
        <img src={items.img} className='w-[200px] object-cover h-[200px] sm:h-[250px] rounded-[1em]' alt="" />
  ...
  return (
    <div className='grid grid-cols-3 gap-[.2em] sm:gap-[1em]'>
      {storyList}
    </div>
  )
}
