  ...
  return (
    <div className='flex gap-[1em] shadow-sm shadow-[--accent1] w-full flex-col relative p-[1em] rounded-[10px]'>
        ...
        <div className='flex items-center justify-center gap-[2em] border-[--accent1]'>
          <Link className='flex p-[.5em] gap-[.5em] rounded-[5px] sm:hover:scale-110 active:scale-[0.9] sm:active:scale-[1] active:duration-[0.1s] duration-[0.5s] bg-[--accent1] text-[--bg] shadow-sm shadow-[--accent1]'>
        ...
        { postNav &&
          <div  className='absolute top-0 left-0 w-full sm:h-full h-[40%] rounded-[5px] bg-[#000000c5]'>
            <FontAwesomeIcon onClick={handlePostNav} className='text-2xl cursor-pointer right-[0.7em] text-white absolute top-[1.4em] text-[--accent1] sm:hover:scale-125 active:duration-[0.1s] active:scale-[0.9] sm:duration-[0.5s] duration-[0.1s]' icon={faTimes}/>
              ...
              <ul className='flex flex-col items-center justify-between h-full '>
                <Link className='flex items-center text- justify-center sm:hover:text-[--bg] sm:hover:bg-[--accent1] orb sm:text-xl text-[1rem] bg-[--bg] h-full w-[200px] border-2 border-[--accent1]'>
                  Delete Post
                </Link>
                <Link className='flex items-center justify-center sm:hover:text-[--bg] sm:hover:bg-[--accent1] orb sm:text-xl text-[1rem] bg-[--bg] h-full w-[200px] border-2 border-[--accent1]'>
                  Report Post
                </Link>
                <Link className='flex items-center justify-center sm:hover:text-[--bg] sm:hover:bg-[--accent1] orb sm:text-xl text-[1rem] bg-[--bg] h-full w-[200px] border-2 border-[--accent1]'>
                  Others
