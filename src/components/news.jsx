...
function News() {
    ...
    <li key={i} className='flex gap-[1em] border-b-2 border-[--accent1] py-[.5em]'>
        ...
        <div className='  w-[30%] gap-[.2em] flex justify-center flex-col'>
            ...
            <div className='flex'>
                <Link className='text-[1.1rem] hover:scale-110 duration-[0.5s] active:text-white active:bg-[accent] hover:text-white hover:bg-[--accent] px-[1em] text-center border-[2px] text-[--accent] border-[--accent] roboto rounded-[.5em]'>Read More</Link>
            </div>
        </div>
    </li>))
