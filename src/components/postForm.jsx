    ...
    <div className='sm:px-[--pdx] px-[1em]'>
        <form action="#" onSubmit={handleSubmit}>
            <p>
                ...
                <textarea placeholder='Write something...' onChange={(e) => (setContent(e.target.value))} name="post" id="post" className='w-full rounded-[5px] outline-none text-[--accent1] bg-[#ffffff2c] shadow-sm shadow-[--accent1] resize-none p-[.5em]' cols="30" rows="5"></textarea>
            </p>
